...
$bonus= mysqli_query($con, "select bonuscount from login where email='".mysqli_real_escape_string($con,$valid_user_id)."'");
...
$answer=$row2['answer'];
$flag=false;
while($row4=mysqli_fetch_array($bonus))
$bonuscount = $row4['bonuscount'];
...
mysqli_query($con,"update login set bonuscount='".mysqli_real_escape_string($con,$bonuscount)."' where email='".mysqli_real_escape_string($con,$valid_user_id)."'");
mysqli_query($con,"update login set skipcount='".mysqli_real_escape_string($con,$scale)."' where email='".mysqli_real_escape_string($con,$valid_user_id)."'");
echo "1";
}
else 
echo "0";
