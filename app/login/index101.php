...
width:20%;
	...
	<script>
		<?php  
			$current_time=time();
			$stop_time=strtotime("today 14:26");
...
<div class="wrapper">
<div class="row">
<div align="center" class="left" style="font-family:treasure;background-image:url('images/rankings.png');background-repeat:no-repeat;">
<br><br>
<p style="text-align:center;padding-left:40px;margin-top:-1px;line-height:0.1;font-size:25px;"><b>Rankings</b></p>

<li style="overflow-y:auto;list-style-type:none">
<?php 
$count=0;
...
echo '</div>';
echo '<button  style="margin-left:auto;margin-right:auto;display:block" class="btn" onclick="submit_ans('.$current_q.');">Submit</button>';
if($bonuscount==1 && $skipcount>0)
{

echo '<button  style="style="margin-left:auto;margin-right:auto;display:block" class="btn" onclick="skip_question('.$current_q.');">Skip</button><br><br><br>';
}
